...
import {getProjectTeam, removeUserFromProject} from "../../services/TeamAPI.ts";
...
const ProjectTeamView = () => {
    ...
    if (isError) {
        return <p>There was an error loading the project team</p>
    }

    if (data) return (
        <>
            <h1 className="text-5xl font-black">Administra tu equipo</h1>
